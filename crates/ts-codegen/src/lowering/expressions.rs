...
pub(super) fn compute_scalar_vars_for_body(stmts: &[oxc_ast::ast::Statement<'_>]) -> NameSet {
...
pub(super) fn compute_non_escaping_allocs(stmts: &[oxc_ast::ast::Statement<'_>]) -> NameSet {
    let mut candidates: NameSet = NameSet::new();
